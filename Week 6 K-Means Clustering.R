...
#TASK: Accuracy = number of correctly classified/(total classified) = 78.85%
#i.e our model has achieved 78.85% accuracy!


iris_features <- subset(iris, select = -Species)
k <- 3
kmeans_model <- kmeans(iris_features, centers = k, nstart = 20)
print(paste("Within-Cluster Sum of Squares (WCSS):", kmeans_model$tot.withinss))
